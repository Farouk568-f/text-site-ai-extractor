# -*- coding: utf-8 -*-
"""
محسن استخراج النص من المقالات العربية
...
def extract_text_from_url(url: str) -> dict:
    ...
    try:
        ...
        for element in text_elements:
            ...
            # فلترة النص المتقدمة
            if len(text) > 30 and len(text) < 20000:
        ...
        if article_texts:
            ...
            if clean_text and len(clean_text) > 1000:  # التأكد من وجود محتوى كافي
        ...
        if all_text:
            ...
            if len(clean_text) > 2000:  # التأكد من وجود محتوى كافي
                return {
                    "status": "success",
                    "url": url,
                    "paragraphs_count": 1,
